...
const seed: RowUser[] = [
  ...doctors.map((d) => ({ id: d.id, name: d.name, email: d.email, role: "doctor" as Role, department: d.department, status: "active" as const })),
  { id: "u-fd1", name: "Priya Menon", email: "priya@medicore.io", role: "frontdesk", department: "Reception", status: "active" },
  { id: "u-fd2", name: "Karan Singh", email: "karan@medicore.io", role: "frontdesk", department: "Reception", status: "active" },
  { id: "u-rn1", name: "Sister Joan Lewis", email: "joan@medicore.io", role: "nurse", department: "OPD", status: "active" },
  { id: "u-rn2", name: "Sister Tara Wu", email: "tara@medicore.io", role: "nurse", department: "ICU", status: "invited" },
  { id: "u-rx1", name: "Rahul Verma", email: "rahul@medicore.io", role: "pharmacy", department: "Pharmacy", status: "active" },
  { id: "u-lab1", name: "Mei Chen", email: "mei@medicore.io", role: "lab", department: "Pathology", status: "active" },
  { id: "u-lab2", name: "Diego Alvarez", email: "diego@medicore.io", role: "lab", department: "Radiology", status: "suspended" },
];
            ...
            <DialogContent>
              ...
              <div className="grid gap-4">
                <div>
                  ...
                  <Input id="n" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="mt-1.5" />
                </div>
                <div>
                  <Label htmlFor="e">Email</Label>
                  <Input id="e" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="mt-1.5" />
                </div>

  ...
  return (
    <div className="grid min-h-screen place-items-center bg-muted/40 px-4">
      <div className="surface-elevated w-full max-w-md p-8">
        <Link to="/forgot-password" className="inline-flex items-center text-xs font-semibold text-muted-foreground hover:text-foreground">
          <ArrowLeft className="mr-1 h-3 w-3" /> Back
        </Link>
        <div className="mt-6 grid h-12 w-12 place-items-center rounded-xl bg-primary/10 text-primary">
          <ShieldCheck className="h-6 w-6" />
        </div>
        <h1 className="mt-4 font-display text-2xl font-bold tracking-tight">Verify your identity</h1>
        ...
        >
          ...
          <p className="text-center text-xs text-muted-foreground">
            Didn't receive it? <button type="button" className="font-semibold text-primary hover:underline" onClick={() => toast("Code resent")}>Resend</button>
          </p>
        </form>
      </div>
    </div>

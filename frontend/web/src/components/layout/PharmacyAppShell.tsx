  ...
  const SidebarContent = () => {
    ...
    return (
      <div className="flex h-full flex-col">
        ...
        {/* Profile Header (Matches reference image design with app theme) */}
        ...
        <div className="px-4 pt-4">
          ...
          >
            ...
            <kbd className="rounded-full border border-sidebar-border bg-sidebar px-1.5 py-0.5 font-mono text-[9px] text-muted-foreground">⌘K</kbd>
          </button>
        </div>
        ...
        <nav className="flex-1 space-y-6 overflow-y-auto px-4 py-4 scrollbar-none">
                  ...
                  <div key={tab.label} className="space-y-1">
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        <Icon className={cn("h-4 w-4 shrink-0 transition-colors", anyChildActive ? "text-primary-foreground" : "text-muted-foreground")} />
                        <span>{tab.label}</span>
                      </div>
                      <ChevronDown
                        className={cn(
          ...
          <div className="pt-2 border-t border-sidebar-border space-y-1.5">
            ...
            >
              <UserCog className={cn("h-4 w-4 shrink-0 transition-colors", pathname === "/profile" ? "text-primary-foreground" : "text-muted-foreground")} />
              <span>Profile</span>
            </Link>
            <Link
              to="/settings"
